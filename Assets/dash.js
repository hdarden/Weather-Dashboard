...
function oneDayForecast (city){ 
 console.log(city);
 var queryURL ="https://api.openweathermap.org/data/2.5/weather?q="+ city +"&appid=c7c8128e2f798fa71501452132a9cc27";
 $.ajax({
  url: queryURL,
  method: "GET",
...
var fiveDayURL ="https://api.openweathermap.org/data/2.5/forecast?q=" + city + "&appid=c7c8128e2f798fa71501452132a9cc27";
